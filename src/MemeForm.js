...
function MemeForm() {
    ...
    const addImage = (e) => {
        ...
        dispatch({ type: "ADD-IMAGE", image: e.target.src, name: e.target.alt, key: uuid() });
    }
    ...
    const addTopText = () => {
        ...
        dispatch({ type: "ADD-TOP-TEXT", topText: topText.value });
    ...
    const addBottomText = () => {
        ...
        dispatch({ type: "ADD-BOTTOM-TEXT", bottomText: bottomText.value });
